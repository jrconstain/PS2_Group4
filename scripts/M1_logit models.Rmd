...
train_prob <- predict(modelo_logit, newdata = train_use, type = "prob")[, "pobre"]
...
# Obtener las probabilidades de la clase "pobre" en el conjunto de entrenamiento
train_prob <- predict(modelo_logit3, newdata = train_use, type = "prob")[, "pobre"]
...
# Obtener las probabilidades de la clase "pobre" en el conjunto de entrenamiento
train_prob <- predict(modelo_EN_1, newdata = train_use, type = "prob")[, "pobre"]
