...
```{r}
# Function to add variables to household from the individual level
agg_personas_to_hogares <- function(df_personas) {
  df_personas %>%
    ...
    select(
      ...
      jefe_max_edu, mean_edu_occ, prop_des,
...
vars <- c(
  ...
  "meanedu_x_propocc","meanedu_x_lp","propocc_x_lp","propocc_x_prest"
)
